Flypoints:
	...
	db SNOWTOP_MOUNTAIN, SPAWN_SNOWTOP
	...
	db POKEMON_LEAGUE,   SPAWN_POKEMON_LEAGUE
	db SHAMOUTI_ISLAND,  SPAWN_SHAMOUTI
	db VALENCIA_ISLAND,  SPAWN_VALENCIA
	db NAVEL_ROCK,       SPAWN_NAVEL
	db NEW_TOWNHALL,	 SPAWN_NEW_TOWNHALL
	db -1
