	...
	tilecoll HEADBUTT_TREE, WARP_CARPET_UP, FLOOR, FLOOR ; 0a
	tilecoll WARP_CARPET_UP, HEADBUTT_TREE, FLOOR, FLOOR ; 0b
	...
	tilecoll FLOOR, TOP_WALL, FLOOR, FLOOR ; a8
	tilecoll WARP_CARPET_LEFT, FLOOR, WARP_CARPET_LEFT, FLOOR ; a9
